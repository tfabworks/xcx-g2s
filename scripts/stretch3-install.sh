...
## execute `sh ./xcx-g2s/scripts/stretch3-install.sh`
...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=AkaDako
EXTENSION_REP=xcx-g2s
EXTENSION_ID=g2s
COLLABORATOR="TFabWorks"
EXTENSION_DESCRIPTION="Connect Grove sensors and actuators."
...
sed -e "s|let formatMessage = .*;|import formatMessage from 'format-message';|" -e "s|extensionURL:.*,||" ${EXTENSION_REP}/src/gui/lib/libraries/extensions/entry/index.jsx > src/lib/libraries/extensions/${EXTENSION_ID}/index.jsx
