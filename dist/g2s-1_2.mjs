...
var en$1 = {
	...
	"g2s.entry.description": "Connect Grove sensors and actuators. (v0.6.0-GS1_2)"
};
var ja$1 = {
	"g2s.entry.name": "AkaDako",
	"g2s.entry.description": "Groveのセンサー・アクチュエーターを接続する。(v0.6.0-GS1_2)"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"g2s.entry.name": "AkaDako",
	"g2s.entry.description": "Groveのセンサー・アクチュエーターをせつぞくする。(v0.6.0-GS1_2)"
}
};
