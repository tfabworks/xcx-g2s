...
var en = {
	...
	"g2s.sendSharedData": "send data: [LABEL] = [DATA]",
...
var ja = {
	...
	"g2s.sendSharedData": "通信ラベル[LABEL]の値に[DATA]をセットして送る",
...
var translations = {
	...
	"g2s.sendSharedData": "つうしんラベル[LABEL]のあたいに[DATA]をセットしておくる",
  ...
  _createClass(ExtensionBlocks, [{
    ...
    value: function connectBoard() {
      ...
      return this.boardConnector.connectedBoard(EXTENSION_ID).then(function (connectedBoard) {
        ...
        _this4.runtime.emit(_this4.runtime.constructor.PERIPHERAL_REQUEST_ERROR, {
          message: "Scratch lost connection to",
    ...
    value: function openSocketForShareServer() {
      ...
      var connecting = new Promise(function (resolve) {
        ...
        server.onopen = function () {
          ...
          _this21.shareServerBackoffAttempt = 0;
          resolve(server);
        };
      });
      ...
      if (this.shareServer) {
        if (!this.isShareServerConnected()) {
          ...
          return new Promise(function (resolve) {
            ...
            return _this22.openSocketForShareServer();
          }).finally(function () {
    ...
    value: function connectToShareServer(args, util) {
      ...
      return this.getShareServer().then(function (server) {
        ...
        if (_this23.dataSharingWasCanceled) return 'Data sharing was canceled by user.';
    ...
    value: function sendSharedData(args, util) {
      ...
      return this.getShareServer().then(function (server) {
        ...
        _this24.shareDataSending = true;
        return fetch(_this24.shareServerSendingURL + encodeURIComponent(_this24.shareGroupID), {
          method: 'POST',
          mode: 'cors',
          headers: {
          ...
          body: JSON.stringify({
            groupId: encodeURIComponent(_this24.shareGroupID),
        ...
        return new Promise(function (resolve) {
          setTimeout(function () {
            _this24.shareDataSending = false;
            resolve();
          }, _this24.shareDataSendingIntervalTime);
        });
      }).catch(function (reason) {
        _this24.shareDataSending = false;
        console.info(reason);
    ...
    value: function updatePrevSharedData() {
      ...
      Object.entries(this.sharedData).forEach(function (_ref) {
        ...
        _this25.prevSharedData[label] = {};
        Object.entries(contentObject).forEach(function (_ref3) {
          var _ref4 = _slicedToArray(_ref3, 2),
              key = _ref4[0],
              value = _ref4[1];

          _this25.prevSharedData[label][key] = value;
        });
      });
    }
    /**
    ...
    value: function whenSharedDataReceived(args) {
      ...
      if (!this.updateLastSharedDataTimer) {
        this.updateLastSharedDataTimer = setTimeout(function () {
          _this26.updatePrevSharedData();

          _this26.updateLastSharedDataTimer = null;
