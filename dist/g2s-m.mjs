...
var AkaDakoBoard = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(AkaDakoBoard, [{
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            availablePorts = [];
                            _iterator = _createForOfIteratorHelper$1(portFilters);
                            _context4.prev = 4;
    ...
    value: function neoPixelConfigStrip(pin, length) {
      ...
      var _iterator2 = _createForOfIteratorHelper$1(this.neoPixel),
          _step2;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                address = 0;
                prevStrip = true;
                _iterator3 = _createForOfIteratorHelper$1(this.neoPixel);
...
var Color = /*#__PURE__*/function () {
  function Color() {
    ...
    if (!mode) {
      ...
      var _iterator = _createForOfIteratorHelper(input.autodetect),
          _step;
  ...
  _createClass(ExtensionBlocks, [{
    ...
    value: function updatePrevSharedData() {
      ...
      Object.entries(this.sharedData).forEach(function (_ref) {
        ...
        _this28.prevSharedData[label] = {};
        Object.entries(contentObject).forEach(function (_ref3) {
          var _ref4 = _slicedToArray(_ref3, 2),
              key = _ref4[0],
              value = _ref4[1];

          _this28.prevSharedData[label][key] = value;
        });
      });
    }
    /**
    ...
    value: function whenSharedDataReceived(args) {
      ...
      if (!this.updateLastSharedDataTimer) {
        this.updateLastSharedDataTimer = setTimeout(function () {
          _this29.updatePrevSharedData();

          _this29.updateLastSharedDataTimer = null;
