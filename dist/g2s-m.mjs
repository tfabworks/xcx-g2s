...
var AkaDakoBoard = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(AkaDakoBoard, [{
    ...
    value: function () {
      var _neoPixelConfigStrip = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8(pin, length) {
        var _this18 = this;

        var oldStrip, message, _iterator2, _step2, aStrip;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                oldStrip = this.neoPixel.find(function (aStrip) {
                ...
                _iterator2 = _createForOfIteratorHelper$2(this.neoPixel);
                ...
                return _context8.abrupt("return", this.neoPixelThrottledOperation(function () {
                  return _this18.firmata.sysexCommand(message);
                }));
      ...
      function neoPixelConfigStrip(_x7, _x8) {
        return _neoPixelConfigStrip.apply(this, arguments);
      }

      return neoPixelConfigStrip;
    }()
    /**
    ...
    value: function () {
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 8:
                ...
                strip.colorsBackup = null; // 色を設定するメッセージを作成
                ...
                return _context9.abrupt("return", this.neoPixelThrottledOperation(function () {
                  return _this19.firmata.sysexCommand(message);
                }));
      ...
      function neoPixelSetColor(_x9, _x10) {
    ...
    value: function () {
      ...
      function neoPixelFillColor(_x11, _x12) {
      ...
      var _neoPixelClearAll = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12() {
        ...
        return regenerator.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                pin = _args12.length > 0 && _args12[0] !== undefined ? _args12[0] : null;
                strips = this.neoPixel;

                if (pin != null) {
                  strips = strips.filter(function (aStrip) {
                    return aStrip.pin === pin;
                  });
                }

                colorsBackups = [];
                _iterator4 = _createForOfIteratorHelper$2(strips);
                _context12.prev = 5;
              ...
              case 7:
                ...
                if (typeof strip.colors !== 'undefined') {
                  ...
                  if (strip.colors.every(function (rgb) {
                    return Array.isArray(rgb) && rgb.every(function (c) {
                      return c === 0;
                    });
                  })) {
                ...
                _context12.next = 13;
                return this.neoPixelFillColor(strip.pin, function () {
                  return [0, 0, 0];
                });
              ...
              case 23:
                _context12.next = 25;
                return this.neoPixelShow(pin);

              case 25:
                _loop2 = function _loop2() {
                  var _colorsBackups$_i = _slicedToArray(_colorsBackups[_i], 2),
                      pin = _colorsBackups$_i[0],
                      colorsBackup = _colorsBackups$_i[1];

                  var strip = _this20.neoPixel.find(function (aStrip) {
                    return aStrip.pin === pin;
                  });
                ...
                for (_i = 0, _colorsBackups = colorsBackups; _i < _colorsBackups.length; _i++) {
                  _loop2();
                }
    ...
    key: "neoPixelShow",
    value: function () {
      var _neoPixelShow = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
        var _this21 = this;
        ...
        return regenerator.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                pin = _args14.length > 0 && _args14[0] !== undefined ? _args14[0] : null;
                ...
                _iterator5 = _createForOfIteratorHelper$2(this.neoPixel);
                _context14.prev = 2;
              ...
              case 8:
                ...
                return _context14.delegateYield( /*#__PURE__*/regenerator.mark(function _callee13() {
                  var backupColors;
                  return regenerator.wrap(function _callee13$(_context13) {
                    while (1) {
                      switch (_context13.prev = _context13.next) {
                        case 0:
                          backupColors = strip.colorsBackup.slice();
                          _context13.next = 3;
                          return _this21.neoPixelFillColor(strip.pin, function (_, idx) {
                            return backupColors[idx];
                          });
              ...
              case 20:
                ...
                return _context14.abrupt("return", this.neoPixelThrottledOperation(function () {
                  return _this21.firmata.sysexCommand(message);
                }));
        ...
        }, _callee14, this, [[2, 14, 17, 20]]);
      }));

      function neoPixelShow() {
        return _neoPixelShow.apply(this, arguments);
      }
    ...
    key: "neoPixelThrottledOperation",
    value: function () {
      var _neoPixelThrottledOperation = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15(operation) {
        var result;
        return regenerator.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                _context15.next = 2;
                return this.neoPixelThrottledQueue(operation);

              case 2:
                result = _context15.sent;

                // PIXEL_SHOWコマンドの場合はpendingShowフラグをクリア
                if (operation().length >= 2 && operation()[1] === nodePixelConstants.PIXEL_SHOW) {
                  this.neoPixel.forEach(function (strip) {
      ...
      function neoPixelThrottledOperation(_x14) {
        return _neoPixelThrottledOperation.apply(this, arguments);
      }

      return neoPixelThrottledOperation;
    }()
  }], [{
    key: "RELEASED",
    get:
  ...
  _createClass(ExtensionBlocks, [{
    ...
    value: function getShareServer() {
      ...
      return this.openShareGroupIDDialog().then(function (groupID) {
        ...
        _this24.shareGroupID = groupID;

        if (groupID === '') {
          return null;
        }

        _this24.prevShareGroupID = groupID;
        return _this24.openSocketForShareServer();
      }).finally(function () {
        _this24.shareServerGetting = false;
      });
    ...
    value: function whenSharedDataReceived(args) {
      ...
      if (!this.updateLastSharedDataTimer) {
        this.updateLastSharedDataTimer = setTimeout(function () {
          _this27.updatePrevSharedData();

          _this27.updateLastSharedDataTimer = null;
