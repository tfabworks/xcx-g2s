...
var en = {
	...
	"g2s.neoPixelShiftColor": "color LEF [CONNECTOR] shift color settings by [N] ([LOOP_MODE])",
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass(ExtensionBlocks, [{
    ...
    value: function resetPinMode() {
      ...
      for (var _i2 = 0, _arr2 = [6, 9, 10, 11]; _i2 < _arr2.length; _i2++) {
        var pin = _arr2[_i2];
    ...
    key: "analogLevelSet",
    value: function () {
      var _analogLevelSet = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(args) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 17:
                ...
                return _context.abrupt("return", this.board.pwmWrite(pin, value));
    ...
    value: function neoPixelConfigStrip(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        var length = cast.toNumber(Number.parseInt(args.LENGTH, 10));
        return _this4.board.neoPixelConfigStrip(pin, length);
      });
    }
    /**
     * Update color of LEDs on the all of NeoPixel modules.
    ...
    value: function neoPixelShow(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function () {
        return _this5.board.neoPixelShow();
      });
    }
    /**
    ...
    value: function neoPixelSetColor(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function (pin) {
        ...
        return _this6.board.neoPixelSetColor(pin, color, index);
      });
    }
    /**
    ...
    value: function neoPixelFillColor(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function (pin) {
        ...
        return _this7.board.neoPixelFillColor(pin, colorFn);
      });
    }
  }, {
    ...
    value: function neoPixelShiftColor(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function (pin) {
        ...
        return _this8.board.neoPixelFillColor(pin, colorMapFn);
      });
    }
    /**
    ...
    value: function neoPixelOperationWithLock(args, util, operation) {
      ...
      var result = operation(pin);

      if (result instanceof Promise) {
        return result.finally(function () {
          _this9.neoPixelBusy = false;
        });
      }
    ...
    value: function neoPixelClear(args, util) {
      ...
      return this.neoPixelOperationWithLock(args, util, function (pin) {
        if (pin == null) return;
        return _this10.board.neoPixelClear(pin);
      });
    }
  }, {
    key: "getOpticalDistanceSensor",
    value: function () {
      var _getOpticalDistanceSensor = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
        ...
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                return _context2.abrupt("return", this.vl53l0x);
    ...
    value: function measureDistanceWithLight(_args, util) {
      ...
      if (Date.now() - this.opticalDistanceUpdatedTime > this.opticalDistanceUpdateIntervalTime) {
        ...
        measureRequest = measureRequest.then(function () {
          return _this11.getOpticalDistanceSensor();
          ...
          _this11.opticalDistance = distance;
          return distance;
        }).finally(function () {
          _this11.opticalDistanceUpdating = false;
        });
      }
      ...
      .then(function (distance) {
        return _this11.reduceNoiseOfOpticalDistance(distance);
      }).catch(function (reason) {
        console.log("measureDistanceWithLight was rejected by ".concat(reason));
        _this11.opticalDistance = null;
        return '';
      });
    }
    /**
    ...
    value: function measureDistanceWithUltrasonicA(_args, util) {
      ...
      if (Date.now() - this.sonicDistanceAUpdatedTime > this.sonicDistanceAUpdateIntervalTime) {
        ...
        getter = getter.then(function () {
          ...
          _this12.sonicDistanceA = value;
          _this12.sonicDistanceAUpdatedTime = Date.now();
          return _this12.sonicDistanceA;
        }).finally(function () {
          _this12.sonicDistanceAUpdating = false;
        });
      }
    ...
    value: function measureDistanceWithUltrasonicB(_args, util) {
      ...
      if (Date.now() - this.sonicDistanceBUpdatedTime > this.sonicDistanceBUpdateIntervalTime) {
        ...
        var pin = 6;
        getter = getter.then(function () {
          return _this13.board.getDistanceByUltrasonic(pin);
        }).then(function (value) {
          _this13.sonicDistanceB = value;
          _this13.sonicDistanceBUpdatedTime = Date.now();
          return _this13.sonicDistanceB;
        }).finally(function () {
          _this13.sonicDistanceBUpdating = false;
        });
      }
    ...
    value: function () {
      var _getAccelerometer = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
        ...
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                isKXTJ3Connected = _context3.sent;
              ...
              case 11:
                isADXL345Connected = _context3.sent;
              ...
              case 20:
                return _context3.abrupt("return", this.accelerometer);
    ...
    key: "getAcceleration",
    value: function () {
      var _getAcceleration = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
        var sensor;
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                sensor = _context4.sent;
                _context4.next = 6;
                return sensor.getAcceleration();

              case 6:
                this.acceleration = _context4.sent;
                this.accelerationUpdatedTime = Date.now();
                return _context4.abrupt("return", this.acceleration);

              case 11:
                _context4.prev = 11;
                _context4.t0 = _context4["catch"](0);
                console.log("getAcceleration() was rejected by ".concat(_context4.t0));
                this.acceleration = null;
    ...
    value: function updateAcceleration(util) {
      ...
      if (Date.now() - this.accelerationUpdatedTime > this.accelerationUpdateIntervalTime) {
        ...
        getRequest = getRequest.then(function () {
          return _this14.getAcceleration();
        }).finally(function () {
          _this14.accelerationUpdating = false;
        });
      }
    ...
    key: "getEnvSensor",
    value: function () {
      var _getEnvSensor = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
        var newSensor;
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                return _context5.abrupt("return", this.envSensor);
    ...
    value: function () {
      var _getEvnTemperature = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(_args, util) {
        var _this15 = this;
            ...
            switch (_context6.prev = _context6.next) {
              ...
              case 7:
                ...
                getter = getter.then(function () {
                  ...
                  return _this15.envSensor.readTemperature();
                }).then(function (envTemperature) {
                  _this15.envTemperature = envTemperature;
                  _this15.envTemperatureUpdatedTime = Date.now();
                  return envTemperature;
                }).finally(function () {
                  _this15.envTemperatureUpdating = false;
                });

              case 9:
                return _context6.abrupt("return", getter.then(function (envTemperature) {
                  return Math.round(envTemperature * 100) / 100;
                }).catch(function (reason) {
                  console.log("getting environment temperature was rejected by ".concat(reason));
                  _this15.envTemperature = null;
    ...
    key: "getEvnPressure",
    value: function () {
      var _getEvnPressure = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(_args, util) {
        var _this16 = this;
            ...
            switch (_context7.prev = _context7.next) {
              ...
              case 5:
                ...
                getter = getter.then(function () {
                  ...
                  return _this16.envSensor.readPressure();
                }).then(function (envPressure) {
                  _this16.envPressure = envPressure;
                  _this16.envPressureUpdatedTime = Date.now();
                  return envPressure;
                }).finally(function () {
                  _this16.envPressureUpdating = false;
                });

              case 7:
                return _context7.abrupt("return", getter.then(function (envPressure) {
                  return Math.round(envPressure * 100) / 10000;
                }).catch(function (reason) {
                  console.log("getting environment pressure was rejected by ".concat(reason));
                  _this16.envPressure = null;
    ...
    key: "getEnvHumidity",
    value: function () {
      var _getEnvHumidity = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8(_args, util) {
        var _this17 = this;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                ...
                getter = getter.then(function () {
                  return _this17.getEnvSensor();
                }).then(function () {
                  return _this17.envSensor.readHumidity();
                }).then(function (envHumidity) {
                  _this17.envHumidity = envHumidity;
                  _this17.envHumidityUpdatedTime = Date.now();
                  return envHumidity;
                }).finally(function () {
                  _this17.envHumidityUpdating = false;
                });

              case 7:
                return _context8.abrupt("return", getter.then(function (envHumidity) {
                  return Math.round(envHumidity * 100) / 100;
                }).catch(function (reason) {
                  console.log("getting environment humidity was rejected by ".concat(reason));
                  _this17.envHumidity = null;
                  _this17.envSensor = null;
                  return '';
                }));
    ...
    value: function () {
      var _getBrightnessSensor = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9() {
        var newSensor;
        return regenerator.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 5:
                return _context9.abrupt("return", this.brightnessSensor);
    ...
    key: "getBrightness",
    value: function () {
      var _getBrightness = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(_args, util) {
        var _this18 = this;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 7:
                ...
                getter = getter.then(function () {
                  return _this18.getBrightnessSensor();
                }).then(function () {
                  return _this18.brightnessSensor.getBrightness();
                }).then(function (brightness) {
                  _this18.brightness = brightness;
                  _this18.brightnessUpdatedTime = Date.now();
                  return brightness;
                }).finally(function () {
                  _this18.brightnessUpdating = false;
                });

              case 9:
                return _context10.abrupt("return", getter.then(function (brightness) {
                ...
                .catch(function (reason) {
                  ...
                  _this18.brightness = null;
                  _this18.brightnessSensor = null;
                  return '';
                }));
    ...
    value: function getTemperatureDS18B20(pin) {
      ...
      return this.board.sendOneWireReset(pin).then(function () {
        return _this19.board.oneWireWrite(pin, 0x44);
      }).then(function () {
        return _this19.board.sendOneWireReset(pin);
      }).then(function () {
        return _this19.board.oneWireWriteAndRead(pin, 0xBE, 9);
    ...
    value: function getWaterTemperatureA(_args, util) {
      ...
      if (Date.now() - this.waterTempAUpdatedTime > this.waterTempAUpdateIntervalTime) {
        ...
        getter = getter.then(function () {
          return _this20.getWaterTemp(10, util);
        }) // Digital A1: 10
        .then(function (waterTempA) {
          _this20.waterTempA = waterTempA;
          _this20.waterTempAUpdatedTime = Date.now();
          return waterTempA;
        }).finally(function () {
          _this20.waterTempAUpdating = false;
        });
      }

      return getter.catch(function (reason) {
        console.log("getting water temperature A was rejected by ".concat(reason));
        _this20.waterTempA = null;
        return '';
      });
    }
    /**
    ...
    value: function getWaterTemperatureB(_args, util) {
      ...
      if (Date.now() - this.waterTempBUpdatedTime > this.waterTempBUpdateIntervalTime) {
        ...
        getter = getter.then(function () {
          return _this21.getWaterTemp(6, util);
        }) // Digital B1: 6;
        .then(function (waterTempB) {
          _this21.waterTempB = waterTempB;
          _this21.waterTempBUpdatedTime = Date.now();
          return waterTempB;
        }).finally(function () {
          _this21.waterTempBUpdating = false;
        });
      }

      return getter.catch(function (reason) {
        console.log("getting water temperature A was rejected by ".concat(reason));
        _this21.waterTempB = null;
        return '';
      });
    }
    /**
          ...
          if (typeof this.prevAccAbsolute !== 'undefined' && this.prevAccAbsolute !== null) {
            ...
            setTimeout(function () {
              updater.then(function (currentAcc) {
                if (currentAcc === '') {
                  _this22.shakeEventUpdating = false;
                  return;
                }

                _this22.shaken = currentAcc - _this22.prevAccAbsolute > _this22.shakeEventThreshold;
                _this22.prevAccAbsolute = currentAcc;
                setTimeout(function () {
                  _this22.shakeEventUpdating = false;
                }, _this22.runtime.currentStepTime);
              }).catch(function (reason) {
                _this22.shakeEventUpdating = false;
    ...
    value: function openShareGroupIDDialog() {
      ...
      return new Promise(function (resolve) {
        ...
        var canceled = function canceled() {
          _this23.dataSharingWasCanceled = true;
          resolveID('');
        };
        ...
        _this23.shareGroupIDDialogOpened = false;
      });
    }
    /**
    ...
    value: function openSocketForShareServer() {
      ...
      var connecting = new Promise(function (resolve) {
        ...
        server.onmessage = function (event) {
          ...
          _this24.sharedData[received.key] = {
        ...
        server.onopen = function () {
          ...
          _this24.shareServer = server;
          _this24.shareServerBackoffAttempt = 0;
          resolve(server);
        };
      });
      return Promise.race([connecting, new Promise(function (resolve) {
        setTimeout(function () {
          resolve(null);
        }, _this24.shareServerConnectWaitingTime);
      })]);
    }
    /**
    ...
    value: function getShareServer() {
      ...
      if (this.shareServer) {
        if (!this.isShareServerConnected()) {
          ...
          return new Promise(function (resolve) {
            ...
            return _this25.openSocketForShareServer();
          }).finally(function () {
      ...
      return this.openShareGroupIDDialog().then(function (groupID) {
        ...
        _this25.shareGroupID = groupID;

        if (groupID === '') {
          return null;
        }

        _this25.prevShareGroupID = groupID;
        return _this25.openSocketForShareServer();
      }).finally(function () {
        _this25.shareServerGetting = false;
      });
    ...
    value: function connectToShareServer(args, util) {
      ...
      return this.getShareServer().then(function (server) {
        ...
        if (_this26.dataSharingWasCanceled) return 'Data sharing was canceled by user.';
    ...
    value: function sendSharedData(args, util) {
      ...
      return this.getShareServer().then(function (server) {
        ...
        _this27.shareDataSending = true;
        return fetch(_this27.shareServerSendingURL + encodeURIComponent(_this27.shareGroupID), {
          method: 'POST',
          mode: 'cors',
          headers: {
          ...
          body: JSON.stringify({
            groupId: encodeURIComponent(_this27.shareGroupID),
        ...
        return new Promise(function (resolve) {
          setTimeout(function () {
            _this27.shareDataSending = false;
            resolve();
          }, _this27.shareDataSendingIntervalTime);
        });
      }).catch(function (reason) {
        _this27.shareDataSending = false;
        console.info(reason);
    ...
    value: function whenSharedDataReceived(args) {
      ...
      if (!this.updateLastSharedDataTimer) {
        this.updateLastSharedDataTimer = setTimeout(function () {
          _this28.updatePrevSharedData();

          _this28.updateLastSharedDataTimer = null;
    ...
    key: "sendIrRemote",
    value: function () {
      var _sendIrRemote = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11(args) {
        var connectorInput, n, connectorValues, CONNECTOR, MIN_INTERVAL;
        return regenerator.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
...
var parseColor = function parseColor(color, brightness) {
  ...
  if (typeof color === 'string') {
    var nums = color.split(',').map(cast.toNumber);
    rgb[0] = nums[0] || 0;
    rgb[1] = nums[1] || 0;
    rgb[2] = nums[2] || 0;
