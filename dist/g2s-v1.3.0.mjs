...
var en = {
	...
	"g2s.askGenerativeAI": "generative AI(β) ask [PROMPT] [TARGET]",
...
var ja = {
	...
	"g2s.askGenerativeAI": "生成AI(β)に[TARGET][PROMPT]と聞く",
...
var translations = {
	...
	"g2s.askGenerativeAI": "せいせいAI(β)に[TARGET][PROMPT]ときく",
...
var encode7bitBytes = function encode7bitBytes(bytes) {
  var transmitBits = 7;
  var transmitMask = (1 << transmitBits) - 1;
  var encoded = [];
  var outstandingBits = 0;
  var outstandingBitCache = bytes[0];
  var bytec = bytes.length;

  for (var i = 0; i < bytec; i++) {
    var transmitByte = (outstandingBitCache | bytes[i] << outstandingBits & 0xFF) & 0xFF;
    encoded.push(transmitByte & transmitMask);
    var shiftVal = transmitBits - outstandingBits;
  ...
  if (outstandingBits != 0) {
    var finalByte = (1 << outstandingBits) - 1 & outstandingBitCache;
...
var decode7bitBytes = function decode7bitBytes(encoded) {
  var bitBuffer = 0;
  var bitCount = 0;
  var decoded = [];
  ...
  for (var i = 0; i < encoded.length; i++) {
    ...
    while (bitCount >= 8) {
      var decodedByte = bitBuffer & 0xFF;
...
var isSignedUidSupportVersion = function isSignedUidSupportVersion(version) {
  return !(version.type == 0 || version.type == 1 || version.type == 2 && version.major < 3 || version.type == 3 && version.major < 3);
...
var AkaDakoBoard = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(AkaDakoBoard, [{
    ...
    value: function setupFirmata(firmata) {
      ...
      firmata.sysexResponse(BOARD_UID_QUERY, function (data) {
    ...
    key: "boardSignedUid",
    value: function boardSignedUid(challenge, timeout) {
      var _this7 = this;

      return this.boardVersion().then(function (version) {
        if (!isSignedUidSupportVersion(_this7.version)) {
          return Promise.resolve([]);
        } else {
          var query = [BOARD_UID_QUERY].concat(encode7bitBytes(challenge));
          var firmata = _this7.firmata;
          timeout = timeout ? timeout : _this7.boardUidWaitingTime;
          var event = "board-uid-reply";
          var request = new Promise(function (resolve) {
            firmata.once(event, function (data) {
              return resolve(decode7bitBytes(data));
            });
    ...
    key: "boardUid",
    value: function boardUid(timeout) {
      var _this8 = this;

      return this.boardVersion().then(function (version) {
        var query = [BOARD_UID_QUERY].concat(isSignedUidSupportVersion(_this8.version) ? encode7bitBytes([0, 0, 0, 0, 0, 0, 0, 0]) : []);
        var firmata = _this8.firmata;
        timeout = timeout ? timeout : _this8.boardUidWaitingTime;
        var event = "board-uid-reply";
        var request = new Promise(function (resolve) {
          firmata.once(event, function (data) {
            return resolve(decode7bitBytes(data));
        ...
        return Promise.race([request, timeoutReject(timeout)]).then(function (data) {
    ...
    value: function enableDevice(deviceID) {
      ...
      return new Promise(function (resolve) {
        _this9.firmata.sysexCommand(message);
    ...
    value: function setInputBias(pin, pullUp) {
      ...
      return new Promise(function (resolve) {
        _this10.pinMode(pin, _this10.pins[pin].inputBias);
    ...
    value: function digitalWrite(pin, value, enqueue) {
      ...
      return new Promise(function (resolve) {
        _this11.firmata.digitalWrite(pin, value, enqueue);
    ...
    value: function pwmWrite(pin, value) {
      ...
      return new Promise(function (resolve) {
        _this12.firmata.pwmWrite(pin, value);
    ...
    value: function servoWrite() {
      ...
      return new Promise(function (resolve) {
        ...
        (_this13$firmata = _this13.firmata).servoWrite.apply(_this13$firmata, args);
    ...
    value: function i2cWrite(address, register, inBytes) {
      ...
      return new Promise(function (resolve) {
        _this14.firmata.i2cWrite(address, register, inBytes);
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass(ExtensionBlocks, [{
    ...
    key: "boardUid",
    value: function boardUid() {
      if (!this.isConnected()) return '';
      return this.board.boardUid().then(function (uid) {
        return uid.map(function (num) {
          return num.toString(16).padStart(2, '0');
        }).join('');
      }).catch(function (reason) {
        console.log("boardUid() was rejected by ".concat(reason));
        return Promise.resolve('');
      });
    }
    /**
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                _context14.next = 4;
                return new Promise(function (resolve) {
                  _this28.runtime.renderer.requestSnapshot(function (imageDataURL) {
    ...
    value: function () {
      var _fetchGenerativeAI = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15(body) {
        ...
        var unixTime, buffer, view, challenge, i, uid, uint8, binary, _i5, url;
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 2:
                ...
                _context15.next = 11;
                return this.board.boardSignedUid(challenge, 3000).then(function (uid) {
                  return uid;
                }).catch(function (reason) {
                  console.log("boardUid() was rejected by ".concat(reason));
                  return [];
              ...
              case 11:
                uid = _context15.sent;
                uint8 = new Uint8Array(challenge.concat(uid));
                binary = '';

                for (_i5 = 0; _i5 < uint8.length; _i5++) {
                  binary += String.fromCharCode(uint8[_i5]);
                }

                this.generativeAIBoardInfo = {
                  expired: false,
                  board: {
                    version: "".concat(this.board.version.type, ".").concat(this.board.version.major, ".").concat(this.board.version.minor),
                    uid: btoa(binary)
                  }
                };
                setTimeout(function () {
                  _this29.generativeAIBoardInfo.expired = true;
                }, 10 * 60 * 1000);
              ...
              case 17:
                ...
                return fetch(url, {
                  ...
                  return body.content !== null ? body.content : body.error !== null ? body.error : '';
                }).catch(function (e) {
