...
var en = {
	...
	"g2s.servoTurn": "Servo [CONNECTOR] turn [ANGLE]",
	...
	"g2s.getTemperature": "temperature (°C)",
	"g2s.getPressure": "pressure (hPa)",
	"g2s.getHumidity": "humidity (%)",
...
var ja = {
	...
	"g2s.servoTurn": "[CONNECTOR]のサーボを[ANGLE]度にする",
	...
	"g2s.getTemperature": "温度(°C)",
	"g2s.getPressure": "気圧(hPa)",
	"g2s.getHumidity": "湿度(%)",
...
var translations = {
	...
	"g2s.digitalLevelSet": "[CONNECTOR]を[LEVEL]にする",
	"g2s.analogLevelSet": "[CONNECTOR]をPWM[LEVEL]にする",
	"g2s.servoTurn": "[CONNECTOR]のサーボを[ANGLE]どにする",
	...
	"g2s.getTemperature": "おんど(°C)",
	"g2s.getPressure": "きあつ(hPa)",
	"g2s.getHumidity": "しつど(%)",
        ...
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 14:
                return _context3.abrupt("return", this.bme280.readTemperature().then(function (temp) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _context4.abrupt("return", Promise.resolve(0));
              ...
              case 14:
                return _context4.abrupt("return", this.bme280.readPressure().then(function (press) {
        ...
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 14:
                return _context5.abrupt("return", this.bme280.readHumidity().then(function (hum) {
