...
var en = {
	...
	"g2s.shareGroupIDDialog.message": "set data sharing group ID",
	"g2s.shareGroupIDDialog.cancel": "cancel",
	"g2s.shareGroupIDDialog.set": "set",
	"g2s.reportShareGroupID": "data sharing group ID",
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  _createClass(ExtensionBlocks, [{
    ...
    key: "connectShareServer",
    value: function connectShareServer() {
      var _this21 = this;
    ...
    value: function sendSharedData(args, util) {
      ...
      return this.getShareServer().then(function (server) {
        ...
        _this23.shareDataSending = true;
        return fetch(_this23.shareServerSendingURL + encodeURIComponent(_this23.shareGroupID), {
          method: 'POST',
          mode: 'cors',
          headers: {
          ...
          body: JSON.stringify({
            groupId: encodeURIComponent(_this23.shareGroupID),
        ...
        return new Promise(function (resolve) {
          setTimeout(function () {
            _this23.shareDataSending = false;
            resolve();
          }, _this23.shareDataSendingIntervalTime);
        });
      }).catch(function (reason) {
        _this23.shareDataSending = false;
        console.info(reason);
    ...
    value: function updatePrevSharedData() {
      ...
      Object.entries(this.sharedData).forEach(function (_ref) {
        ...
        _this24.prevSharedData[label] = {};
        Object.entries(contentObject).forEach(function (_ref3) {
          var _ref4 = _slicedToArray(_ref3, 2),
              key = _ref4[0],
              value = _ref4[1];

          _this24.prevSharedData[label][key] = value;
        });
      });
    }
    /**
    ...
    value: function whenSharedDataReceived(args) {
      ...
      if (!this.updateLastSharedDataTimer) {
        this.updateLastSharedDataTimer = setTimeout(function () {
          _this25.updatePrevSharedData();

          _this25.updateLastSharedDataTimer = null;
